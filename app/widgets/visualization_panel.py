"""
Panel de visualizaciones para Flash View Sheet
Proporciona gráficos y visualizaciones de datos usando matplotlib y seaborn
"""
...
class VisualizationPanel(QWidget):
    ...
    def generate_plot(self):
        ...
        self.worker = VisualizationWorker(self.df, plot_type.lower().replace(' ', ''), columns)
